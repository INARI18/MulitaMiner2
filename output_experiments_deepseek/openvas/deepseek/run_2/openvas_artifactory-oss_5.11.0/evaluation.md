...
- results: `output_experiments\openvas\deepseek\run_2\openvas_artifactory-oss_5.11.0\results.json`
...
- extracted records: 116
- matched: 116  (recall 1.000, precision 1.000)
...
description               -      -       -           -           0.951      0.821    0.821   
solution                  -      -       -           -           0.872      0.642    0.642   
impact                    -      -       -           -           0.634      0.632    0.632   
insight                   -      -       -           -           0.864      0.809    0.810   
references                -      0.055   0.290       -           -          -        -       
detection_result          -      -       -           -           0.932      0.887    0.887   
detection_method          -      -       -           -           0.897      0.849    0.850   
product_detection_result  -      -       -           -           0.954      0.908    0.908   
log_method                -      -       -           -           0.910      0.768    0.770   
plugin                    n/a    -       -           -           -          -        -       
plugin_details            -      -       -           n/a         -          -        -       
...
- **description**: Apache Tomcat Rewrite Rule Bypass Vulnerability (Apr 2025) - Linux (0.542); Apache Tomcat CORS Filter Setting Security Bypass Vulnerability (0.559); OS Detection Consolidation and Reporting (0.718); Services (0.752); Services (0.752)
...
- **product_detection_result**: Apache Tomcat AJP RCE Vulnerability (Ghostcat) - Active Check (0.0); Apache JServ Protocol (AJP) v1.3 Detection (TCP) (0.0); Apache Tomcat Detection Consolidation (0.0); Apache Tomcat Security Constraint Incorrect Handling Access Bypass Vulnerabilities - Linux (0.69); Apache Tomcat Authentication Bypass Vulnerability (Nov 2024) - Linux (0.715)
- **log_method**: Apache Tomcat Multiple Vulnerabilities (Dec 2024) - Linux (0.0); HTTP Security Headers Detection (0.258); Allowed HTTP Methods Enumeration (0.447); Hostname Determination Reporting (0.571); IP Forwarding Enabled - Active Check (0.607)
